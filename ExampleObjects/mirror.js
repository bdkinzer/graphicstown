...
(function() {
    ...
    image.src = "https://farm3.staticflickr.com/2855/9336627756_bd88ba703f_b.jpg";   //useful util function to return a glProgram from just vertex and fragment shader source.
    ...
    var test = new TexturedPlane();
        test.position[1] = 2.01;
        test.position[0] = -2.0;
        test.position[2] = 5.0;
        test.name = "kaleidescope";
        test.scale = [.5, .5];
